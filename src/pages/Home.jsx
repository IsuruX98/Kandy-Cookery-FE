  ...
  return (
    <div className="flex flex-col">
      ...
      >
        ...
        >
          <h1 className="lg:text-[48px] text-4xl text-white mb-4">
            Discover the Flavors of Sri Lanka
          </h1>
          <p className="lg:text-[48px] text-4xl mb-4 sm:text-5xl">
            A Culinary Adventure Awaits!
          </p>
          <p className="lg:text-[24px] text-xl mb-8 sm:text-2xl">
            Unleash Your Inner Chef in Sri Lanka!
          </p>
          <button
            onClick={openModal}
